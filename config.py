...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6051355293:AAEYRRHDtYnoJ08-9js8nx7XL9O4Sx2JrLw")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001862548997"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1477133497").split()):
        ADMINS.append(int(x))
except ValueError:
